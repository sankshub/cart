package com.sank.bookshop.front.mapper;
...
public interface RequestResponseMapper {
    ...
    List<com.sank.bookshop.front.model.BookSet> mapBookSetModel(List<BookSet> source);
    ...
    com.sank.bookshop.front.model.BookSet mapBookSetModel(BookSet source);
